...
void *vectorPop(Vector *v); // remove element at last index. usage : (myStruct *)vectorPop(v);
...
void *vectorRemove(Vector *v, size_t i); // return the struct at indice i and move next elements to the left
